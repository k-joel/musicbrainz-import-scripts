// ==UserScript==
// @name         Import Neowing releases to MusicBrainz
// @namespace    https://github.com/k-joel/musicbrainz-import-scripts
// @version      0.1
// @description  Adds a button to Neowing's product page to import that release into MusicBrainz
// @author       k-joel
// @downloadURL  https://github.com/k-joel/musicbrainz-import-scripts/raw/main/neowing-musicbrainz-import.user.js
// @updateURL    https://github.com/k-joel/musicbrainz-import-scripts/raw/main/neowing-musicbrainz-import.user.js
// @match        http*://www.neowing.co.jp/product/*
...
// @require      file://D:/Code/musicbrainz-import-scripts/dev/Testing-neowing-musicbrainz-import.user.js
// ==/UserScript==
...
$(document).ready(function () {
    ...
    let buttons = 
        ...
        makeSearchButton(release).replace("<span>Search in MB</span>", 
            "<i class='fa fa-search' style='padding-right: 5px'></i><span>Search in MB</span>");
...
function makeReleaseInfo(releaseUrl) {
    ...
    let various_artists = artist == 'オムニバス';
    if (various_artists) {
    ...
    // Release Date
    let releaseDate = $("table.basic-info span[itemprop='releaseDate']").text().split(' ')[0].trim();
    ...
    $("table.tracklist tbody").children().each(function () {
        trackname = this.lastElementChild.innerHTML.trim();
